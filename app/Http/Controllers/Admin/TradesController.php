...
class TradesController extends Controller
{
	...
	public function index(Request $request)
	{
		...
		return view('admin.trades.index', compact(
						'trades', 'tradexs', 'deposits', 'soldtrades', 'balance', 'total',
						'depositbalance', 'soldOutTotal', 'deuda', 'qty')
		);
	}
	...
	public function store(TradeStoreRequest $request)
	{
		...
		$ticket = new Ticket();
		if ($request->input('action') == "CGO Broker Guaranty Payment" or $request->input('action') == "Bank Trans Fee" or $request->input('action') == "Withdrawal Funds") {
		...
		if ($ticketId->action == "CGO Broker Guaranty Payment" or $ticketId->action == "Bank Trans Fee" or $ticketId->action == "Withdrawal Funds") {
