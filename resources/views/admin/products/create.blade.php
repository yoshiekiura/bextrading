            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-group" action="{{ route('prod.post') }}" method="post">
                            {{ csrf_field() }}
                            <div class="col-md-9">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group" {{ $errors->has('name') ? 'has-error' : '' }}>
                                            ...
                                            <input name="name" type="text" class="form-control"
                                                   value="{{ old('name') }}"/> {!! $errors->first('name', '
           <span style="color: #ff2c23" class="help-block">:message</span>') !!}
                                        </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group" {{ $errors->has('symbol') ? 'has-error' : '' }}>
                                                ...
                                                <input name="symbol" type="text" class="form-control"
                                                       value="{{ old('symbol') }}"/> {!! $errors->first('symbol', '
           <span style="color: #ff2c23" class="help-block">:message</span>') !!}
                                            </div>
                                        </div>
                                    </div>
          ...
          <span class="input-group-addon">
           <span class="fa fa-balance-scale"></span>
                                                ...
                                                <input name="leverage" type="text" class="form-control"
                                                       value="{{ old('leverage') }}"/> {!! $errors->first('leverage', '
         <span style="color: #ff2c23" class="help-block">:message</span>') !!}
                                            </div>
                                        </div>
          ...
          <span class="input-group-addon">
           <span class="fa fa-dollar"></span>
                                                    ...
                                                    <input name="marketval" type="text" class="form-control"
                                                           value="{{ old('marketval') }}"/> {!! $errors->first('marketval', '
         <span style="color: #ff2c23" class="help-block">:message</span>') !!}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-md-offset-4">
                                            <button type="submit" class="btn btn-primary">
                                                <i class="fas fa-sign-in-alt"></i> Create Product
                                            </button>
                                        </div>
                                    </div>
                                </div>
