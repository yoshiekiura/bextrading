        ...
        <div class="col-xs-12">
            ...
            <div class="col-xs-6">
                <address>
                    ...
                    <strong>Account Nº5470 {{ $trade->ticket->user_id }}</strong>
...
@endphp
                            ...
                            <tr>
                                <td class="text-center">{{ $trade->ticket->product->symbol.$trade->ticket->month->code.$trade->ticket->year->year
                                    }}</td>
                            ...
                            <tr>
                                ...
                                <td class="thick-line text-right">{{ money_format('%i', $trade->ticket->qty * $trade->ticket->price) }}</td>
                            </tr>
                            <tr>
                                <td class="no-line"></td>
                                <td class="no-line"></td>
                                ...
                                <td class="no-line text-right">{{ money_format('%i',$trade->ticket->fee->amount * $trade->ticket->qty) }}</td>
                            </tr>
                            <tr>
                                <td class="no-line"></td>
                                <td class="no-line"></td>
                                ...
                                <td class="no-line text-right">{{ money_format('%i', $trade->ticket->qty * $trade->ticket->price + $trade->ticket->fee->amount
                                    * $trade->ticket->qty) }}</td>
                            </tr>
                        </tbody>
                    </table>
